# m-claude Prompt Engineering Guide

> Internal guide for writing quality prompts for the m-claude system.
...
## Purpose
One sentence: why this workflow exists.
...
---
name: m-claude Style
description: Response format for m-claude
---
# Identity
